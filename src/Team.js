...
const people = [
  ...
  },
  {
	...
	bio: 'Software Engineer at Amazon. Bachelor’s in Computer Science from Cal-Berkeley. Developer for The Faces Fund.',
					...
					{people.map(person => (
						<li key={person.name}>
							<div className="space-y-4">
								...
								{person.twitterUrl && <ul className="flex space-x-5">
									<li>
									<a href={person.twitterUrl} className="text-white hover:text-gray-300">
